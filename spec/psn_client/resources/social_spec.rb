  ...
  describe "#presence" do
    it "fetches primary presence for the authenticated account" do
      ...
      allow(connection).to receive(:get)
        .with(:mobile, "/api/userProfile/v2/internal/users/me/basicPresences", { "type" => "primary" })
    ...
    it "resolves another user's online ID and survives an empty body" do
      ...
      allow(connection).to receive(:get)
        .with(:mobile, "/api/userProfile/v2/internal/users/42/basicPresences", { "type" => "primary" })
        .and_return({})
